...
axs = sns.violinplot(data=df_merged, x="mito?", y="ves_vol", hue="Condition",order=['n','y'],
...
axs.set_ylabel(r'SV Vol ($\mu m^3$)',fontsize=9,labelpad=0.3)
...
# =============================================================================
#plt.savefig('/Users/guadagar/Documents/trabajo/mito_project/axon_cytoplasm/figures/new_5_2025/violin_ves_vol_JB023.png',dpi =600)#,bbox_inches='tight')
plt.show()
a = 'ves_vol'
